import { LitElement as w, html as _, css as x, state as h, customElement as T } from "@umbraco-cms/backoffice/external/lit";
...
}, g = (t, e, r) => e.has(t) || b("Cannot " + r), o = (t, e, r) => (g(t, e, "read from private field"), r ? r.call(t) : e.get(t)), c = (t, e, r) => e.has(t) ? b("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), N = (t, e, r, a) => (g(t, e, "write to private field"), e.set(t, r), r), n, f, v, y;
...
//# sourceMappingURL=dashboard.element-Cs93TisS.js.map
