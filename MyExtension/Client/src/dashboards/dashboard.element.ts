...
import { MyExtensionService, UserModel } from "../api/index.js";
...
export class ExampleDashboardElement extends UmbElementMixin(LitElement) {
  ...
  #onClickWhoAmI = async (ev: Event) => {
    ...
    const { data, error } = await MyExtensionService.whoAmI();
  ...
  #onClickWhatsTheTimeMrWolf = async (ev: Event) => {
    ...
    const { data, error } = await MyExtensionService.whatsTheTimeMrWolf();
  ...
  #onClickWhatsMyName = async (ev: Event) => {
    ...
    const { data, error } = await MyExtensionService.whatsMyName();
