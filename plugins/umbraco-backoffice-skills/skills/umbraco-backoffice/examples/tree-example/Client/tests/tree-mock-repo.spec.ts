/**
 * Tests using mock repository approach.
 *
 * Run the dev server with:
 *   VITE_EXTERNAL_EXTENSION=.../Client/mock \
 *   npm run dev:external
 *
 * This approach replaces the repository at the extension level (no network mocking).
 */
...
test.describe('Our Tree Extension (Mock Repository)', () => {
  ...
  test('should display root tree items from mock repository data', async ({ page }) => {
    // These names come from mock/mock-data.ts
